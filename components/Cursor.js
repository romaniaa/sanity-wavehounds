    ...
    <>
      {showCursor &&
        <div
            ...
            { image && 
                <div className="transition-all duration-300 w-[200px] h-[200px] rounded-full overflow-hidden" style={{ left: cursorPosition.x, top: cursorPosition.y }}>
                    <WhImage className={'object-cover '} sizes={'(max-width: 1024px) 250px, 300px'} value={image} alt="Project Image" />
                </div>
            }
        </div>
      }
