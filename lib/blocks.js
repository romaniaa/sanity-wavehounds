...
const blocks = {
    ...
    // },
    image: {
        component: ({value}) => <div className={'container-wide py-24 laptop:py-50'}><VitalImage className={'w-full'} value={value} sizes={'(max-width: 1920px) 100vw, 1920px'} captionClass={'w-full laptop:w-5/12'} /></div>,
        projections: [
            `...`,
